...
public class DesafioLamb{
    ...
    //         if (precoBase >= 2500) {
    //             final double valorFrete = 100;
    //             double taxa = taxaMunicipios.getOrDefault(p.municipio, 0.0);
    //             double valorTotal = precoBase * (1 + taxa) + valorFrete;
    //             System.out.println("Produto: " + p.nome + " | Município: " + p.municipio + " | Frete: " + valorFrete);
    //             System.out.println("Valor com taxa: " + String.format("R$ %.2f", valorTotal));
    //             System.out.println();
    //         } else{
    //             final double valorFrete = 50;
    //             double valorTotal = precoBase + valorFrete;
    //             System.out.println("Produto: " + p.nome + " | Município: " + p.municipio + " | Frete: " + valorFrete);
    ...
    public static void main(String[] args) {
        ...
        UnaryOperator<Double> impostoMunicipio = 
        ...
        String preco = precoFinal.andThen(impostoMunicipio).andThen(frete).andThen(formatar).apply(p);
